...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "IOS Paul started advertising function or”
  ...
  s.description  = <<-DESC
                   IOS Paul started advertising function 
  DESC
  ...
  # Or just: s.author    = "liubin"
  # s.authors            = { "liubin" => "lbjobvip@163.com" }
  # s.social_media_url   = "http://twitter.com/liubin"
  ...
  s.source_files  = "LBLaunchImageAd", "LBLaunchImageAd/**/*.{h,m}"
